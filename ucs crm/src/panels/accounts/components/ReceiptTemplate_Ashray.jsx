...
const ashrayLogo = '/receipt-assets/ahsraylogo.png'
const ashrayStamp = '/receipt-assets/ashraystamp.PNG'
...
export default function ReceiptTemplate_Ashray({ donor, index, signature, project }) {
