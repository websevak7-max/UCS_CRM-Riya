  ...
  return (
    <div className="print-page">
      <style>{`
        ...
        .t3{width:210mm;min-height:297mm;height:auto !important;margin:auto;background:#fff;border:3px solid #222;padding:8mm 10mm;font-family:"Times New Roman",serif;page-break-after:always}
        .t3 h1{text-align:center;margin:0 0 2px;font-size:22pt}
        .t3 .sub{text-align:center;font-size:10pt;margin:0 0 6px}
        .t3 .red{height:2px;background:#7b2020;margin:2px 0 6px}
        .t3 .sec{color:#7b2020;font-weight:bold;font-size:12pt;margin-top:8px}
        .t3 .title{text-align:center;color:#1f3f73;font-size:15pt;font-weight:bold;margin:12px 0}
        .t3 p{font-size:10.8pt;line-height:1.45;text-align:justify;margin:2px 0}
        ...
        .t3 .footer{border-top:2px solid #7b2020;margin-top:8px;padding-top:5px;text-align:center;font-size:10pt;line-height:1.4}
      `}</style>
      <div className="t3">
